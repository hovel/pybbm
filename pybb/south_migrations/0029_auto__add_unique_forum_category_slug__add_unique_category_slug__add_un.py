...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Forum', fields ['category', 'slug']
        db.create_unique(u'pybb_forum', ['category_id', 'slug'])

        # Adding unique constraint on 'Category', fields ['slug']
        db.create_unique(u'pybb_category', ['slug'])

        # Adding unique constraint on 'Topic', fields ['forum', 'slug']
        db.create_unique(u'pybb_topic', ['forum_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Topic', fields ['forum', 'slug']
        db.delete_unique(u'pybb_topic', ['forum_id', 'slug'])

        # Removing unique constraint on 'Category', fields ['slug']
        db.delete_unique(u'pybb_category', ['slug'])

        # Removing unique constraint on 'Forum', fields ['category', 'slug']
        db.delete_unique(u'pybb_forum', ['category_id', 'slug'])
