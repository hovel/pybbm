...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pybb_forumsubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'forum_subscriptions+', to=orm['auth.User'])),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'subscriptions+', to=orm['pybb.Forum'])),
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'pybb', ['ForumSubscription'])

        # Adding unique constraint on 'ForumSubscription', fields ['user', 'forum']
        db.create_unique(u'pybb_forumsubscription', ['user_id', 'forum_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ForumSubscription', fields ['user', 'forum']
        db.delete_unique(u'pybb_forumsubscription', ['user_id', 'forum_id'])

        # Deleting model 'ForumSubscription'
        db.delete_table(u'pybb_forumsubscription')
    ...
    models = {
        ...
        u'pybb.forumsubscription': {
            'Meta': {'unique_together': "((u'user', u'forum'),)", 'object_name': 'ForumSubscription'},
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'subscriptions+'", 'to': u"orm['pybb.Forum']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'forum_subscriptions+'", 'to': u"orm['auth.User']"})
        },
        u'pybb.pollanswer': {
