...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('pybb_forumsubscription', ['user_id', 'forum_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ForumSubscription', fields ['user', 'forum']
        db.delete_unique('pybb_forumsubscription', ['user_id', 'forum_id'])

        # Deleting model 'ForumSubscription'
        db.delete_table('pybb_forumsubscription')
    ...
    models = {
        ...
        'pybb.forumsubscription': {
            'Meta': {'unique_together': "(('user', 'forum'),)", 'object_name': 'ForumSubscription'},
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions+'", 'to': "orm['pybb.Forum']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forum_subscriptions+'", 'to': "orm['auth.User']"})
        },
        'pybb.pollanswer': {
