...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pybb_post', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'posts', to=orm[AUTH_USER])),
        ...
        db.create_table('pybb_profile', (
            ...
            ('user', self.gf('annoying.fields.AutoOneToOneField')(related_name=u'pybb_profile', unique=True, to=orm[AUTH_USER])),
            ('markup', self.gf('django.db.models.fields.CharField')(max_length=15)),
