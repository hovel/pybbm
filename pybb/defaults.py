...
SUBSCRIBE_MODE_ALL = 1
SUBSCRIBE_MODE_PERM = 2
SUBSCRIBE_MODE_DISABLED = 3
PYBB_TOPIC_SUBSCRIBE_MODE = getattr(settings, 'PYBB_TOPIC_SUBSCRIBE_MODE', SUBSCRIBE_MODE_ALL)
